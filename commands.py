...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://t.me/pinpharmacy"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔔 BOT Updates 🤖', url='https://t.me/pinpharmacy')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('OFFICIAL WEBSITE', url='https://pinpharmacy.com')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
